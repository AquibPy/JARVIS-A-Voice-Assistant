...
'mn': 'mongolian', 'my': 'myanmar (burmese)', 'ne': 'nepali', 'no': 'norwegian', 'ps': 'pashto', 'fa': 'persian', 'pl': 'polish',
...
# result = traslator.detect(text1)
# print(result)

translated = traslator.translate('hello how are you',dest='hi',src='en')
